...
<body>
    ...
    <header>
        <div id="logo">
            <img src="img/logo2.png" alt="Sumermarketm&b" id="imagen">
        </div>
        <div id="datos">
            <p id="encabezado">
                <b>Sumermarketm&b</b><br>Montero - Santa Cruz, Bolivia<br>Telefono:(+591) 77363585<br>Email:Sumermarketm&b@gmail.com
            </p>
        </div>
        <div id="fact">
