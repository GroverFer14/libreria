        ...
        <template v-else-if="listado==0">
          <div class="card-body">
            ...
            <div class="form-group row border">
              ...
              <template v-if="delivery == 1">
                <div class="col-md-2">
                  <div class="form-group">
                    <label>Conductor</label>
                    <select v-model="idConductor" class="form-control">
                      <option value="0" disabled>Seleccione</option>
                      <option v-for="conductor in arrayConductor" :key="conductor.id" :value="conductor.id" v-text="conductor.usuario"></option>
                    </select>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" value="" class="form-control" v-model="ubicacion" placeholder="Ingrese la dirección">
                  </div>
                </div>
              </template>
            </div>
...
export default {
  ...
  methods: {
    ...
    selectConductor() {
      let me = this;
      var url = "/user/conductor";
      axios
        .get(url)
        .then(function (response) {
          var respuesta = response.data;
          me.arrayConductor = respuesta.conductores;
          console.log(respuesta.conductores);
          console.log(me.arrayConductor);
        })
        .catch(function (error) {
          console.log(error);
        });
